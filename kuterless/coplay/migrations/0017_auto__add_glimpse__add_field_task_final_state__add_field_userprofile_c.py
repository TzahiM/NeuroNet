...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Glimpse'
        db.create_table(u'coplay_glimpse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('viewer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.Viewer'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'coplay', ['Glimpse'])

        # Adding field 'Task.final_state'
        db.add_column(u'coplay_task', 'final_state',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.can_limit_discussion_access'
        db.add_column(u'coplay_userprofile', 'can_limit_discussion_access',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Glimpse'
        db.delete_table(u'coplay_glimpse')

        # Deleting field 'Task.final_state'
        db.delete_column(u'coplay_task', 'final_state')

        # Deleting field 'UserProfile.can_limit_discussion_access'
        db.delete_column(u'coplay_userprofile', 'can_limit_discussion_access')
    ...
    models = {
        ...
        u'coplay.glimpse': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'viewer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coplay.Viewer']"})
        },
        u'coplay.segment': {
