...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.status_picture'
        db.add_column(u'coplay_task', 'status_picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.status_picture'
        db.delete_column(u'coplay_task', 'status_picture')
    ...
    models = {
        ...
        u'coplay.task': {
            ...
            'status_picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
