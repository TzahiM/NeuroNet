...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.locked_at'
        db.add_column(u'coplay_discussion', 'locked_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 23, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.locked_at'
        db.delete_column(u'coplay_discussion', 'locked_at')
    ...
    models = {
        ...
        u'coplay.discussion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 23, 0, 0)'}),
