...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'coplay_userprofile', (
            ...
            ('segment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.Segment'], null=True, blank=True)),
            ('recieve_notifications', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('recieve_updates', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'coplay', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'coplay_userprofile')
