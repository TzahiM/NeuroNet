...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viewer.discussion_updated_at_on_last_view'
        db.add_column(u'coplay_viewer', 'discussion_updated_at_on_last_view',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Viewer.discussion_updated_at_on_last_view'
        db.delete_column(u'coplay_viewer', 'discussion_updated_at_on_last_view')
