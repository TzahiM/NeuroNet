...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.recieve_notifications'
        db.add_column(u'coplay_userprofile', 'recieve_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.recieve_updates'
        db.add_column(u'coplay_userprofile', 'recieve_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.recieve_notifications'
        db.delete_column(u'coplay_userprofile', 'recieve_notifications')

        # Deleting field 'UserProfile.recieve_updates'
        db.delete_column(u'coplay_userprofile', 'recieve_updates')
