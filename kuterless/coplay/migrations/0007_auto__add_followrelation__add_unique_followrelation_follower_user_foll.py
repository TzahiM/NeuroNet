...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowRelation'
        db.create_table(u'coplay_followrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('follower_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower_user', to=orm['auth.User'])),
            ('following_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='following_user', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'coplay', ['FollowRelation'])

        # Adding unique constraint on 'FollowRelation', fields ['follower_user', 'following_user']
        db.create_unique(u'coplay_followrelation', ['follower_user_id', 'following_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FollowRelation', fields ['follower_user', 'following_user']
        db.delete_unique(u'coplay_followrelation', ['follower_user_id', 'following_user_id'])

        # Deleting model 'FollowRelation'
        db.delete_table(u'coplay_followrelation')
    ...
    models = {
        ...
        u'coplay.viewer': {
            ...
            'is_allowed_to_participate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
