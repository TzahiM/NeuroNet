...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discussion.parent_url_text'
        db.alter_column(u'coplay_discussion', 'parent_url_text', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'Discussion.parent_url'
        db.alter_column(u'coplay_discussion', 'parent_url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Discussion.parent_url_text'
        db.alter_column(u'coplay_discussion', 'parent_url_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Discussion.parent_url'
        db.alter_column(u'coplay_discussion', 'parent_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
