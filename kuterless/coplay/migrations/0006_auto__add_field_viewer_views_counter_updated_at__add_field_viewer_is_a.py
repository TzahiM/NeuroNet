...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viewer.views_counter_updated_at'
        db.add_column(u'coplay_viewer', 'views_counter_updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Viewer.is_a_follower'
        db.add_column(u'coplay_viewer', 'is_a_follower',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Viewer.is_allowed_to_participate'
        db.add_column(u'coplay_viewer', 'is_allowed_to_participate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Viewer.views_counter_updated_at'
        db.delete_column(u'coplay_viewer', 'views_counter_updated_at')

        # Deleting field 'Viewer.is_a_follower'
        db.delete_column(u'coplay_viewer', 'is_a_follower')

        # Deleting field 'Viewer.is_allowed_to_participate'
        db.delete_column(u'coplay_viewer', 'is_allowed_to_participate')
