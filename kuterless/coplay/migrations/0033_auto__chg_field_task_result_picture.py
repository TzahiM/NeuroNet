...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.result_picture'
        db.alter_column(u'coplay_task', 'result_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'coplay.task': {
            ...
            'result_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'uploads/%Y/%m/%d/no-name.jpg'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
