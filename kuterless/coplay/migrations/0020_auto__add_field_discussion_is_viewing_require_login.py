...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.is_viewing_require_login'
        db.add_column(u'coplay_discussion', 'is_viewing_require_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.is_viewing_require_login'
        db.delete_column(u'coplay_discussion', 'is_viewing_require_login')
