...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.url'
        db.alter_column(u'memecache_transaction', 'url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.url'
        db.alter_column(u'memecache_transaction', 'url', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
