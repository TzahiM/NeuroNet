...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSelection.created_at'
        db.add_column(u'memecache_productselection', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'ProductSelection.updated_at'
        db.add_column(u'memecache_productselection', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'Cart.created_at'
        db.add_column(u'memecache_cart', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductSelection.created_at'
        db.delete_column(u'memecache_productselection', 'created_at')

        # Deleting field 'ProductSelection.updated_at'
        db.delete_column(u'memecache_productselection', 'updated_at')

        # Deleting field 'Cart.created_at'
        db.delete_column(u'memecache_cart', 'created_at')
