...
class PublicFulfillmentTest(TestCase):
    ...
    def test_obtain_auth_token(self):
        ...
        self.assertEquals(  str(response.data),  "{'non_field_errors': [ErrorDetail(string='Unable to log in with provided credentials.', code='authorization')]}")
        ...
        self.assertEquals(  request.body, b'{"username":"zugu","password":"1234"}')
