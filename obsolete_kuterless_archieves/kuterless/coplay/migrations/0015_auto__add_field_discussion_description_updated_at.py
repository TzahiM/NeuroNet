...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.description_updated_at'
        db.add_column(u'coplay_discussion', 'description_updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.description_updated_at'
        db.delete_column(u'coplay_discussion', 'description_updated_at')
