...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_limit_discussion_to_login_users_only'
        db.add_column(u'coplay_userprofile', 'can_limit_discussion_to_login_users_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_limit_discussion_to_login_users_only'
        db.delete_column(u'coplay_userprofile', 'can_limit_discussion_to_login_users_only')
