...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'coplay_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num', self.gf('django.db.models.fields.IntegerField')()),
            ('street', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default=u'\u05d9\u05e9\u05e8\u05d0\u05dc', max_length=2, blank=True)),
        ...
        db.send_create_signal(u'coplay', ['Location'])

        # Adding field 'Discussion.location'
        db.add_column(u'coplay_discussion', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.location'
        db.add_column(u'coplay_userprofile', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.Location'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'coplay_location')

        # Deleting field 'Discussion.location'
        db.delete_column(u'coplay_discussion', 'location_id')

        # Deleting field 'UserProfile.location'
        db.delete_column(u'coplay_userprofile', 'location_id')
    ...
    models = {
        ...
        u'coplay.location': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "u'\\u05d9\\u05e9\\u05e8\\u05d0\\u05dc'", 'max_length': '2', 'blank': 'True'}),
