...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.voice_recording'
        db.add_column(u'coplay_feedback', 'voice_recording',
                      self.gf('django.db.models.fields.files.FileField')(max_length=5000000, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Task.result_picture'
        db.alter_column(u'coplay_task', 'result_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=50000, null=True))

    def backwards(self, orm):
        # Deleting field 'Feedback.voice_recording'
        db.delete_column(u'coplay_feedback', 'voice_recording')


        # Changing field 'Task.result_picture'
        db.alter_column(u'coplay_task', 'result_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'coplay.task': {
            ...
            'result_picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '50000', 'null': 'True', 'blank': 'True'}),
