...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viewer.just_updated_flag'
        db.add_column(u'coplay_viewer', 'just_updated_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Viewer.just_updated_flag'
        db.delete_column(u'coplay_viewer', 'just_updated_flag')
    ...
    models = {
        ...
        u'coplay.viewer': {
            ...
            'just_updated_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'views_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'views_counter_updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
