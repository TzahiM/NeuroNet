...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.latitude'
        db.add_column(u'coplay_discussion', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Discussion.longitude'
        db.add_column(u'coplay_discussion', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.latitude'
        db.add_column(u'coplay_userprofile', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.longitude'
        db.add_column(u'coplay_userprofile', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.latitude'
        db.delete_column(u'coplay_discussion', 'latitude')

        # Deleting field 'Discussion.longitude'
        db.delete_column(u'coplay_discussion', 'longitude')

        # Deleting field 'UserProfile.latitude'
        db.delete_column(u'coplay_userprofile', 'latitude')

        # Deleting field 'UserProfile.longitude'
        db.delete_column(u'coplay_userprofile', 'longitude')
