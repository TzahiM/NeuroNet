...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.location_desc'
        db.add_column(u'coplay_discussion', 'location_desc',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.location_desc'
        db.add_column(u'coplay_userprofile', 'location_desc',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Location.state'
        db.alter_column(u'coplay_location', 'state', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'Discussion.location_desc'
        db.delete_column(u'coplay_discussion', 'location_desc')

        # Deleting field 'UserProfile.location_desc'
        db.delete_column(u'coplay_userprofile', 'location_desc')


        # Changing field 'Location.state'
        db.alter_column(u'coplay_location', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))
