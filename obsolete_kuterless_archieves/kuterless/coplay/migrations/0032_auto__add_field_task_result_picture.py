...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.result_picture'
        db.add_column(u'coplay_task', 'result_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='uploads/%Y/%m/%d/no-name.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.result_picture'
        db.delete_column(u'coplay_task', 'result_picture')
    ...
    models = {
        ...
        u'coplay.task': {
            ...
            'result_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'uploads/%Y/%m/%d/no-name.jpg'", 'max_length': '100'}),
