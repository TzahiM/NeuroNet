...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnonymousVisitorViewer'
        db.create_table(u'coplay_anonymousvisitorviewer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('anonymous_visitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.AnonymousVisitor'])),
        ...
        db.send_create_signal(u'coplay', ['AnonymousVisitorViewer'])

        # Adding model 'AnonymousVisitor'
        db.create_table(u'coplay_anonymousvisitor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'coplay', ['AnonymousVisitor'])

        # Deleting field 'Glimpse.anonymous_viewer'
        db.delete_column(u'coplay_glimpse', 'anonymous_viewer_id')

        # Adding field 'Glimpse.anonymous_visitor_viewer'
        db.add_column(u'coplay_glimpse', 'anonymous_visitor_viewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['coplay.AnonymousVisitorViewer'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AnonymousVisitorViewer'
        db.delete_table(u'coplay_anonymousvisitorviewer')

        # Deleting model 'AnonymousVisitor'
        db.delete_table(u'coplay_anonymousvisitor')
        ...
        # Deleting field 'Glimpse.anonymous_visitor_viewer'
        db.delete_column(u'coplay_glimpse', 'anonymous_visitor_viewer_id')
