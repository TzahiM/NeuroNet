...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Viewer.is_invited'
        db.add_column(u'coplay_viewer', 'is_invited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Discussion.is_restricted'
        db.add_column(u'coplay_discussion', 'is_restricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Viewer.is_invited'
        db.delete_column(u'coplay_viewer', 'is_invited')

        # Deleting field 'Discussion.is_restricted'
        db.delete_column(u'coplay_discussion', 'is_restricted')
