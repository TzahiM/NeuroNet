...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.total_earn'
        db.add_column(u'memecache_account', 'total_earn',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Account.total_spent'
        db.add_column(u'memecache_account', 'total_spent',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.total_earn'
        db.delete_column(u'memecache_account', 'total_earn')

        # Deleting field 'Account.total_spent'
        db.delete_column(u'memecache_account', 'total_spent')
    ...
    models = {
        ...
        u'memecache.account': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'total_earn': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'total_spent': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
