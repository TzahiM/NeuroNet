...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.updated_at'
        db.add_column(u'memecache_transaction', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.updated_at'
        db.delete_column(u'memecache_transaction', 'updated_at')
