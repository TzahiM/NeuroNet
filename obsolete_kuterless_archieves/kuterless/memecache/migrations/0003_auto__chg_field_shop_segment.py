...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shop.segment'
        db.alter_column(u'memecache_shop', 'segment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplay.Segment'], null=True))

    def backwards(self, orm):

        # Changing field 'Shop.segment'
        db.alter_column(u'memecache_shop', 'segment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['coplay.Segment']))
